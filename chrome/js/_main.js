...
function kGit()
{
  ...
  this.initExtension = function()
  {
	...
	//global singleton object
	  ...
	  this.s.include('observer','hash','application','preference','file','string','thread','prompt','extension','urls','array','date','document','tab','window','notification','listener','places','shell','timer','sharedMemory');
	...
	*/
	...
	if(this.s.isWindows())
	{
	  ...
	  this.s.addListener(
						 ...
						 'onLocationChange',
						 function(aDoc){ kgit.onLocationChange(aDoc);}
						);
  ...
  this.onLocationChange = function(aEvent)
  {
	var aLocation = this.s.documentGetLocation(this.s.documentGetFromTab(aEvent.originalTarget));
	var aMenus = [
				  'kgit-toolbarbutton',
